...
Security hardening. No wire-protocol or identity-file behavior changed: API request bodies, `as_dict(include_secrets=True)`, and identity-file round-trips still carry the real secret values.
